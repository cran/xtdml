...
> 6. Vignettes will be added soon.
...
Polselli A (2025). **xtdml**: Double Machine Learning for Static Panel Models with Fixed Effects. R package version 0.1.12, URL https://cran.r-project.org/web/packages/xtdml/
index.html
